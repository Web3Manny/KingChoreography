...
"[project]/frontend/app/api/submissions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    const priceResult = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$pricing$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["calculatePrice"])(service, body.athlete_count || 1, body.is_existing_client || false, body.session_length || null, body.consultation_addon || false);
    const data = {
        ...body,
    ...
    if (service.service_type === 'free_tier') {
        ...
        const reviewWeek = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$pricing$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assignReviewWeek"])(new Date());
        data.review_week = reviewWeek;
        // Ensure review week exists
        const existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseGet"])('review_weeks', `week_start=eq.${reviewWeek}`);
        if (!existing.length) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabasePost"])('review_weeks', {
                week_start: reviewWeek,
                capacity: 20,
                current_count: 1
            });
        } else {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabasePatch"])('review_weeks', `week_start=eq.${reviewWeek}`, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__46c0cd92._.js.map