...
"[project]/frontend/app/api/admin/queue/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const [submissions, weekData] = await Promise.all([
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseGet"])('submissions', `review_week=eq.${week}&order=submitted_at.asc`).catch(()=>[]),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseGet"])('review_weeks', `week_start=eq.${week}`).catch(()=>[])
    ]);
    return __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        week: weekData[0] || {
            week_start: week,
            capacity: 20,
            current_count: submissions.length
        },
        submissions
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f546ba7a._.js.map