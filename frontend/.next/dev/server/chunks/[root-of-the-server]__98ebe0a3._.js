...
"[project]/frontend/app/api/admin/stats/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const [apps, subs, paid, queued] = await Promise.all([
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseGet"])('applications', `submitted_at=gte.${weekAgo}&select=id`).catch(()=>[]),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseGet"])('submissions', `submitted_at=gte.${weekAgo}&select=id`).catch(()=>[]),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseGet"])('submissions', `payment_status=eq.paid&submitted_at=gte.${monthStart}&select=calculated_amount`).catch(()=>[]),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseGet"])('submissions', `review_status=eq.queued&select=id`).catch(()=>[])
    ]);
    const revenue = paid.reduce((s, r)=>s + parseFloat(r.calculated_amount || 0), 0);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__98ebe0a3._.js.map