...
export default function ApplyPage() {
  ...
  const [form, setForm] = useState({
    ...
    services_interested: [] as string[], team_levels: [] as string[], divisions: [] as string[],
  ...
  const toggleArray = (field: string, value: string) => {
    setForm(prev => ({
      ...prev,
      [field]: (prev as any)[field].includes(value) ? (prev as any)[field].filter((v: string) => v !== value) : [...(prev as any)[field], value]
    }))
  }
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" animate="visible" variants={fadeUp} transition={{ duration: 0.6 }} className="mb-12">
            ...
            <h1 className="font-heading text-4xl sm:text-5xl font-bold uppercase mt-4 mb-4 text-white">Apply for<br /><span className="text-gold-gradient">Availability</span></h1>
          ...
          >
            ...
            <div className="space-y-4">
              <h3 className="font-heading text-lg font-bold uppercase text-white border-b border-white/10 pb-2">Program Info</h3>
            ...
            {/* Services */}
            <div className="space-y-4">
              <h3 className="font-heading text-lg font-bold uppercase text-white border-b border-white/10 pb-2">Services Interested In</h3>
            ...
            {/* Team Levels */}
            <div className="space-y-4">
              <h3 className="font-heading text-lg font-bold uppercase text-white border-b border-white/10 pb-2">Team Details</h3>
              <div>
            ...
            {/* Timing & Referral */}
            <div className="space-y-4">
              <h3 className="font-heading text-lg font-bold uppercase text-white border-b border-white/10 pb-2">Timing & Referral</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
